...
{
    public class NoticeDomainService : INoticeDomainService
    {
        private readonly IDbContextFace<Notice> server;
        public NoticeDomainService(IDbContextFace<Notice> server)
        {
            this.server = server;
        }
        ...
        /// <returns></returns>
        public async Task<Notice> CreateNotice(Notice model)
        {
        ...
        /// <returns></returns>
        public async Task<IList<Notice>> Pagin(int PageNum, int PageSize)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public async Task<Notice> RemovedNotice(Guid Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public async Task<Notice> SingleNotice(Guid Id)
        {
